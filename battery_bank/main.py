...
class BatteryBankService:
    ...
    def _persist(self) -> None:
        persisted = to_persisted(self._state, time.time())
        # The thermal filter changes every sample; rewriting it more often than the save
        # cadence would wear the flash without a matching benefit.
        thermal_refresh_due = (
