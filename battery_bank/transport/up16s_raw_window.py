...
LIMIT_CURRENT_SANE_AMPS = (0.0, 400.0)
LIMIT_VOLTAGE_SANE_VOLTS = (35.0, 70.0)
SOC_SANE_PERCENT = (0.0, 100.0)
EXTREME_TOLERANCE_MILLIVOLTS = 0.1
EXTREME_TOLERANCE_CELSIUS = 0.01
AVERAGE_TOLERANCE_MILLIVOLTS = 1.1
AVERAGE_TOLERANCE_CELSIUS = 0.11
CELL_SUM_TOLERANCE_VOLTS = 0.011
DEADBAND_TOLERANCE_AMPS = 2.1
OPERATION_SIGN_TOLERANCE_AMPS = 2.1
CROSS_VOLTAGE_TOLERANCE_VOLTS = 4.0
CROSS_CELL_TOLERANCE_MILLIVOLTS = 500.0
CROSS_SOC_TOLERANCE_PERCENT = 5.0
CROSS_TEMPERATURE_TOLERANCE_CELSIUS = 5.0
CROSS_MOSFET_TEMPERATURE_TOLERANCE_CELSIUS = 10.0
